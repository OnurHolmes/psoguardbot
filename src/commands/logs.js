...
module.exports = {
  ...
  async execute(client, interaction, db,) {
    if(!interaction.member.permissions.has("Administrator")) return interaction.reply("Bu komudu sadece yönetici yetkisine sahip kişiler kullanabilir.");
    ...
    let embed = new EmbedBuilder()
      .setTitle("PSO Türkiye Guard & Logs Botu")
