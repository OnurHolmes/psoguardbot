...
module.exports = {
  ...
  async execute(client, interaction, db) {
    if(!interaction.member.permissions.has(PermissionFlagsBits.Administrator)) return interaction.reply("Bu komudu sadece yönetici yetkisine sahip kişiler kullanabilir.");
